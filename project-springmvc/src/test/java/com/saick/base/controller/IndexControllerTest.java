...
public class IndexControllerTest extends BaseControllerTest {
    ...
    private static String url = "/user/responseJSONList.action";
    
    @Test
    public void testCoontroller01() throws Exception {
        ...
        mockMvc.perform(
                MockMvcRequestBuilders.post(url).header("content-type",
